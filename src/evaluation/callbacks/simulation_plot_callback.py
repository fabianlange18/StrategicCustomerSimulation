...
class SimulationPlotCallback(BaseCallback):
    ...
    def _on_step(self) -> bool:
        ...
        if (self.num_timesteps - self.last_time_trigger) >= self.n_steps:
            ...
            infos_deterministic = simulate_policy(self.model, deterministic=True, prog_bar=False)
            infos_stochastic = simulate_policy(self.model, deterministic=False, prog_bar=False)
